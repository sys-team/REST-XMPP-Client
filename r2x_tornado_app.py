...
class TornadoApp(object):
    def __init__(self, debug=False, push_app_id='im',
        ...
        self._app = tornado.web.Application([
            ...
            (r"/sessions/([^/]*)/mucs/([^/]*)", MucHandler, dict(session_pool=self._xmpp_session_pool, async_worker=self._async_worker)),
            (r"/sessions/([^/]*)/mucs/([^/]*)/messages", MucMessagesHandler, dict(session_pool=self._xmpp_session_pool, async_worker=self._async_worker)),
